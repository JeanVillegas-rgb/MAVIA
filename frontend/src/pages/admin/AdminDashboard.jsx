...
export default function AdminDashboard() {
  return <AppShell nav={[
    ...
    <section className="mv-card"><h2 className="mv-card__title">Adaptive configuration</h2>
      <p>The existing adaptive engine is preserved. The new weight editor and student roster require a separate backend integration and are not enabled here.</p></section>
  </AppShell>;
}
